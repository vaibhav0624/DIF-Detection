document.addEventListener("DOMContentLoaded", function() {
    ...
    function showAlterationMessage() {
        statusMessage.innerHTML = '<h3>Fingerprint Verified</h3><p style= background-color: #f8d7da; color: #721c24; padding: 15px; text-size: 10px; border-radius: 5px;">The fingerprint has been successfully matched in the database. Access is granted.</p>';
    }
